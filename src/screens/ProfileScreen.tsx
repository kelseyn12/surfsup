...
const ProfileScreen: React.FC = () => {
  ...
  const user: User = {
    id: 'user123',
    username: 'surfer_girl',
    email: 'surfergirl@example.com',
    name: 'Kelly Slater',
    preferences: {
  ...
  const recentSessions: SurfSession[] = [
    {
      ...
      duration: 120,
      rating: 4,
      notes: 'Clean conditions, fun waves around head high.',
      board: 'shortboard',
      conditions: {
        waveHeight: 5.5,
        windSpeed: 5,
    ...
    },
    {
      ...
      userId: user.id,
      surfSpotId: '1',
      surfSpotName: 'Pacifica',
      date: new Date('2023-09-10').toISOString(),
      startTime: '07:00',
      endTime: '08:30',
      duration: 90,
      rating: 3,
      notes: 'Choppy but still caught some good waves.',
      board: 'fish',
      conditions: {
        waveHeight: 4.0,
        windSpeed: 10,
